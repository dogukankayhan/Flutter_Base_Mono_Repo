...
abstract final class AppBrandColors {
  ...
  static final Color shadowBlack = const Color(0xFF000000).withValues(alpha: 0.5);
  ...
  static const Color tertiaryDisabledButtonBorder = Color(0xFFd1aeff); // tertiary[30]
  static const Color tertiaryDisabledButtonFg     = Color(0xFFd1aeff); // tertiary[30]
  ...
  static final Color textFieldDisabledBorder =
      const Color(0xFF8a91a6).withValues(alpha: .6); // gray[40] @60%
  static final Color textFieldDisabled =
      const Color(0xFF8a91a6).withValues(alpha: .6); // gray[40] @60%

  // ─── Gradients ────────────────────────────────────────
  static const LinearGradient mainGradient = LinearGradient(
    colors: [Color(0xFF3ad7f2), Color(0xFF5b7dfb)], // secondary[40] → primary[40]
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );

  static const LinearGradient secondaryGradient = LinearGradient(
    colors: [Color(0xFFf588ff), Color(0xFF8e3afa)], // fourth[40ish] → tertiary[60]
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );
}
