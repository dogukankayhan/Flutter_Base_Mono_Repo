...
extension StringExt on String {
  ...
  /// "hello world" → "Hello World"
  String get titleCase => split(' ').where((e) => e.isNotEmpty).map((e) => e.capitalize).join(' ');
  ...
  String get initials =>
      trim().split(' ').where((e) => e.isNotEmpty).map((e) => e[0].toUpperCase()).join();
  ...
  bool get isUrl => Uri.tryParse(this)?.hasAbsolutePath == true && startsWith('http');
}
